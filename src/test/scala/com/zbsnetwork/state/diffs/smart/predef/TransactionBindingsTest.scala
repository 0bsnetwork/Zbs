    ...
    val ctx =
      PureContext
        ...
        CryptoContext
          .build(Global) |+|
        ZbsContext
          .build(V2, new ZbsEnvironment(chainId, Coeval(null), null, EmptyBlockchain), isTokenContext = true)
    ...
    val ctx =
      PureContext.build(V2) |+|
        CryptoContext
          .build(Global) |+|
        ZbsContext
          .build(V2, new ZbsEnvironment(chainId, Coeval(t), null, EmptyBlockchain), isTokenContext = false)
