...
import com.zbsnetwork.lang.Version.ExprV2
import com.zbsnetwork.lang.Testing.evaluated
import com.zbsnetwork.lang.v1.compiler
import com.zbsnetwork.lang.v1.compiler.ExpressionCompilerV1
import com.zbsnetwork.lang.v1.compiler.Terms.{CONST_BOOLEAN, CONST_LONG, EVALUATED}
...
class TransactionBindingsTest extends PropSpec with PropertyChecks with Matchers with TransactionGen with NoShrink {
  ...
  def runForAsset(script: String): Either[String, EVALUATED] = {
    ...
    import com.zbsnetwork.lang.v1.CTX._
    ...
    val ctx =
      PureContext
        ...
        CryptoContext
          .build(Global) |+|
        ZbsContext
          .build(ExprV2, new ZbsEnvironment(chainId, Coeval(null), null, EmptyBlockchain), isTokenContext = true)
    ...
    val ctx =
      PureContext.build(ExprV2) |+|
        CryptoContext
          .build(Global) |+|
        ZbsContext
          .build(ExprV2, new ZbsEnvironment(chainId, Coeval(t), null, EmptyBlockchain), isTokenContext = false)
