...
import com.zbsnetwork.matcher.model.OrderHistorySpecification._
import com.zbsnetwork.matcher.{MatcherKeys, MatcherTestData}
...
class OrderHistorySpecification
  ...
  property("Delete order") {
    ...
    openVolume(pk, pair.amountAsset) shouldBe 0 // We receive 210000000 >> 300000 ZBS
