...
class SetScriptTransactionSpecification extends GenericTransactionSpecification[SetScriptTransaction] {
  ...
  def transactionParser: com.zbsnetwork.transaction.TransactionParserFor[SetScriptTransaction] = SetScriptTransaction
  ...
  def generator: Gen[((Seq[com.zbsnetwork.transaction.Transaction], SetScriptTransaction))] = setScriptTransactionGen.map(t => (Seq(), t))
