...
object Keys {
  ...
  def zbsBalanceHistory(addressId: BigInt): Key[Seq[Int]] = historyKey(5, addressId.toByteArray)
  ...
  val addressesForZbsSeqNr: Key[Int]                = intKey(37)
  def addressesForZbs(seqNr: Int): Key[Seq[BigInt]] = Key(h(38, seqNr), readBigIntSeq, writeBigIntSeq)
