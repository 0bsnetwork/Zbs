...
import com.zbsplatform.lang.v1.traits.{Proven, _}
    ...
    tx match {
      ...
      case ms: MassTransferTransaction =>
        Tx.MassTransfer(
          ...
          transfers = ms.transfers.map(r => com.zbsplatform.lang.v1.traits.TransferItem(r.address, r.amount)).toIndexedSeq,
