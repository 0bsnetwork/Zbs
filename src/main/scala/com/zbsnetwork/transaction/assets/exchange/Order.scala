...
import com.zbsplatform.serialization.{BytesSerializable, Deser, JsonSerializable}
import com.zbsplatform.state.ByteStr
import com.zbsplatform.transaction.ValidationError.{GenericError, InvalidSignature}
