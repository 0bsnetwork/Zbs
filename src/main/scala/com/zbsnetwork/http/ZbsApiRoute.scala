...
import com.zbsplatform.api.http.{ApiRoute, DiscontinuedApi}
...
@Api(value = "zbs")
@Deprecated
case class ZbsApiRoute(settings: RestAPISettings, wallet: Wallet, utx: UtxPool, allChannels: ChannelGroup, time: Time)
    extends ApiRoute
    with BroadcastRoute {

  override lazy val route = pathPrefix("zbs") {
