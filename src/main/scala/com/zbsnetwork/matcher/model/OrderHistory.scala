...
import com.zbsplatform.database.{DBExt, Key, RW}
import com.zbsplatform.matcher.api.DBUtils
import com.zbsplatform.matcher.model.Events._
import com.zbsplatform.matcher.model.LimitOrder._
import com.zbsplatform.matcher.{MatcherKeys, MatcherSettings, OrderAssets}
...
class OrderHistory(db: DB, settings: MatcherSettings) extends ScorexLogging {
  ...
  import com.zbsplatform.matcher.MatcherKeys._
