...
import com.zbsnetwork.matcher.MatcherSettings.EventsQueueSettings
import com.zbsnetwork.matcher.api.OrderBookSnapshotHttpCache
import com.zbsnetwork.matcher.queue.{KafkaMatcherQueue, LocalMatcherQueue}
...
object MatcherSettings {
  ...
  def fromRootConfig(config: Config): MatcherSettings = config.as[MatcherSettings]("zbs.matcher")
