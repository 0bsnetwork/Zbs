...
inTask(docker)(
  Seq(
    dockerfile := {
      ...
      val startZbs       = sourceDirectory.value / "container" / "start-zbs.sh"
        ...
        Tests.SubProcess(
          ForkOptions(
            ...
            runJVMOptions = Vector(
              ...
              "-Dzbs.it.logging.appender=FILE",
              s"-Dzbs.it.logging.dir=${logDirectoryValue / suite.name.replaceAll("""(\w)\w*\.""", "$1.")}"
            ) ++ javaOptionsValue,
            connectInput = false,
