package com.zbsnetwork.lang.v1.evaluator.ctx.impl.zbs
...
import com.zbsnetwork.lang.v1.compiler.Types.{BYTESTR, LONG, STRING, _}
...
import com.zbsnetwork.lang.v1.traits.domain.{OrdType, Recipient}
...
object ZbsContext {
  ...
  def build(version: StdLibVersion, env: Environment, isTokenContext: Boolean): CTX = {
    ...
    val txByIdF: BaseFunction = {
      val returnType = com.zbsnetwork.lang.v1.compiler.Types.UNION.create(UNIT +: anyTransactionType.l)
    ...
    val assetBalanceF: BaseFunction =
      NativeFunction(
        ...
        ("addressOrAlias", addressOrAliasType, "account"),
        ("assetId", UNION(UNIT, BYTESTR), "assetId (ZBS if none)")
      ) {
    ...
    val zbsBalanceF: UserFunction =
      UserFunction("zbsBalance", 109, LONG, "get ZBS balanse for account", ("@addressOrAlias", addressOrAliasType, "account")) {
    ...
    val commonVars = Map(
      ("height", ((com.zbsnetwork.lang.v1.compiler.Types.LONG, "Current blockchain height"), LazyVal(EitherT(heightCoeval)))),
    )
