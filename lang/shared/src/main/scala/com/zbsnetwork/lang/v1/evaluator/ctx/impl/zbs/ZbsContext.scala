package com.zbsplatform.lang.v1.evaluator.ctx.impl.zbs

import cats.data.EitherT
import com.zbsplatform.lang.v1.compiler.Terms._
import com.zbsplatform.lang.v1.compiler.Types.{BYTEVECTOR, LONG, STRING, _}
import com.zbsplatform.lang.v1.evaluator.FunctionIds._
import com.zbsplatform.lang.v1.evaluator.ctx._
import com.zbsplatform.lang.v1.evaluator.ctx.impl.{EnvironmentFunctions, PureContext}
import com.zbsplatform.lang.v1.evaluator.ctx.impl.PureContext.fromOption
import com.zbsplatform.lang.v1.traits._
import com.zbsplatform.lang.v1.{CTX, FunctionHeader}
...
object ZbsContext {
  ...
  def build(env: Environment): CTX = {
    ...
    val txByIdF: BaseFunction = {
      val returnType = com.zbsplatform.lang.v1.compiler.Types.UNION.create(com.zbsplatform.lang.v1.compiler.Types.UNIT +: anyTransactionType.l)
    ...
    val zbsBalanceF: UserFunction = UserFunction("zbsBalance", LONG, "@addressOrAlias" -> addressOrAliasType) {
    ...
    val vars: Map[String, (FINAL, LazyVal)] = Map(
      ("height", (com.zbsplatform.lang.v1.compiler.Types.LONG, LazyVal(EitherT(heightCoeval)))),
    ...
    CTX(Types.zbsTypes, vars, functions)
  }
}
