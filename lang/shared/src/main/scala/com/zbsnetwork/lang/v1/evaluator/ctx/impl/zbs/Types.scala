...
import com.zbsplatform.lang.v1.evaluator.ctx.CaseType
...
object Types {
  ...
  val zbsTypes = Seq(addressType, aliasType, transfer, orderType, assetPairType, dataEntryType) ++ transactionTypes
}
