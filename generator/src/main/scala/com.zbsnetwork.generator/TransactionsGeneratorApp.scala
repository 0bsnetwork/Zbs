...
import com.zbsnetwork.generator.Preconditions.{PGenSettings, UniverseHolder}
import com.zbsnetwork.generator.cli.ScoptImplicits
import com.zbsnetwork.generator.config.FicusImplicits
import com.zbsnetwork.generator.utils.Universe
...
import com.zbsnetwork.utils.{LoggerFacade, NTP}
...
object TransactionsGeneratorApp extends App with ScoptImplicits with FicusImplicits with EnumerationReader {
  ...
  // IDEA bugs
  implicit val inetSocketAddressReader        = com.zbsnetwork.settings.inetSocketAddressReader
