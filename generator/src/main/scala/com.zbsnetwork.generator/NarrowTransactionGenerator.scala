...
import cats.Show
import com.zbsplatform.generator.NarrowTransactionGenerator.Settings
import com.zbsplatform.state.DataEntry.{MaxValueSize, Type}
import com.zbsplatform.state.{BinaryDataEntry, BooleanDataEntry, ByteStr, EitherExt2, IntegerDataEntry}
import org.slf4j.LoggerFactory
import com.zbsplatform.account.{Alias, PrivateKeyAccount}
...
import com.zbsplatform.transaction.lease.{LeaseCancelTransaction, LeaseCancelTransactionV1, LeaseTransactionV1}
  ...
  def generate(n: Int): Seq[Transaction] = {
    ...
    val tradeAssetIssue = IssueTransactionV1
      .selfSigned(
        ...
        "TRADE".getBytes,
        "Zbs DEX is the best exchange ever".getBytes,
        100000000,
        2,
        reissuable = false,
